      ...
      child: Row(
        children: [
          Container(
            ...
            child: Specialite( image:"https://assets3.lottiefiles.com/packages/lf20_cbajnb2e.json",nom: "",),
          ),
          Container(
            margin: EdgeInsets.symmetric(horizontal: 30),
            padding: EdgeInsets.symmetric(vertical:25, horizontal: 25),
            ...
            child: etat( image:"https://assets3.lottiefiles.com/packages/lf20_pkbvwwvg/bienvenida.sifz.4ECFE884.json",nom: "",),
          ),
        ],
      ),
    );
