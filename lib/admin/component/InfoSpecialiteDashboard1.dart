...
class InfoSpecialiteDasboard1 extends StatelessWidget {
  const InfoSpecialiteDasboard1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [ Image.asset('assets/images/special.png',width: 50,),
